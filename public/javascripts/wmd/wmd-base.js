...
_e1();
_6.skin(_b8,_2.basePath+"",_b2,_b3);
...
_fa.width="50px";
_fa.height="25px";
_fb.href="http://daringfireball.net/projects/markdown/syntax";
_fb.target="_blank";
_fb.title="Markdown Editing Help";
var _fc=_6.createImage("images/help.png");
var _fd=_6.createImage("images/help-on.png");
_fb.appendChild(_fc);
_fb.onmouseover=function(){
_6.setImage(_fc,"images/help-on.png");
...
if(_152){
_154=_6.prompt("<p style='margin-top: 0px'><b>Introdueix la URL de la imatge.</b></p><p>També pots afegir un títol, que serà mostrat com una tool tip.</p><p>Exemple:<br />http://wmd-editor.com/images/cloud1.jpg   \"Títol opcional\"<br /><br /><a target='_blank' href='http://imageshack.us/'>ImageShack</a> </p>","http://",_155);
}else{
_154=_6.prompt("<p style='margin-top: 0px'><b>Introdueix l'adreça web.</b></p><p>També pots afegir un títol, que serà mostrat com una tool tip.</p><p>Exemple:<br />http://wmd-editor.com/   \"Títol opcional\"</p>","http://",_155);
}
return true;
}
};
